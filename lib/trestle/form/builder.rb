...
module Trestle
  class Form
    class Builder < ActionView::Helpers::FormBuilder
      ...
      # The `#display` method is defined on `Kernel.`
      # Undefine it so that the Builder instance will not `respond_to?(:display)`
      # allowing the method to be dispatched to the template helpers instead.
      ...
      # FIXME: See Rubocop Lint/IneffectiveAccessModifier
